...
public class PaymentType implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        PaymentType other = (PaymentType) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getName() == null ? other.getName() == null : this.getName().equals(other.getName()))
            && (this.getPayMonthCount() == null ? other.getPayMonthCount() == null : this.getPayMonthCount().equals(other.getPayMonthCount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPayMonthCount() == null) ? 0 : getPayMonthCount().hashCode());
